...
## Issues
- Browse the [issues](https://github.com/lugnitdgp/GSoC_Slack-Clone/issues) currently raised and select one that you would like to work on.
- Each issue is labeled according to its difficulty level.
- If you encounter a new issue that isn't listed, feel free to raise a new issue on the [issues page](https://github.com/lugnitdgp/GSoC_Slack-Clone/issues) of the repository.
